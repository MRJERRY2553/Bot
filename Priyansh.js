...
exec("rm -rf modules/commands/data && mkdir -p modules/commands/data && rm -rf modules/commands/tad/* ", (error, stdout, stderr) => {
    ...
    console.log(chalk.bold.hex("#00ffff")("MR JERRY (SUNNY) ❯ ") + chalk.hex("#00ffff")("fixed by MR JERRY (SUNNY)"))
});
...
console.log(chalk.bold.hex("#00ffff").bold("[ MR JERRY (SUNNY) ] » ") + chalk.bold.hex("#00ffff").bold("Initializing variables..."));
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`MR JERRY`, '[ MR JERRY (SUNNY) ]');
        logger('Hey, thank you for using this Bot', '[ MR JERRY (SUNNY) ]');
        logger("Fixed by JERRY", '[ MR JERRY (SUNNY) ]');
